...
'Add this to the search as an AND term': 'Añada esto a la búsqueda como un término  AND',
'Add this to the search as an OR term': 'Añada esto a la búsqueda como un término OR',
...
'Start building a new search': 'Empezar a construir una nueva búsqueda',
